...
$(document).ready(function(){
	...
	$(document).ready(function(){
	    ...
	    $(".answerWriteBtn").on("click", function(){
	        ...
	        alert ("댓글등록완료!");
	        formObj.attr("action", "answerWrite");
	        formObj.attr("method", "post");
	        formObj.submit();
		...
		$(".answerDeleteBtn").on("click", function(){
			...
			if(msg == true) {
			 ...
			 var val = $(this).attr("data-a_uid");
				 ...
				 formObj.attr("action", "deleteAnswer");
			     formObj.attr("method", "post");
			     formObj.submit(); 
			}
	});
	...
	<section id="container">
		<form name="readForm" role="form" method="post">
			...
			<form name="answerForm" method="post" class="form-horizontal">
				...
				<div class="form-group">
					<label for="a_writer" class="col-sm-2 control-label">댓글 작성자</label>
					<div class="col-sm-10">
						<input type="text" id="a_writer" name="a_writer" class="chk form-control" title="작성자를 입력하세요" />
					</div>
				</div>
			...
			<form name="deleteForm" role="form" method="post" action="deleteAnswer">
